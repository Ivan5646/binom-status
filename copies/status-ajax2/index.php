...
<form class="status">
    <input type="text" name="cnv_id" id="cnv_id">
    <input type="text" name="cnv_status" id="cnv_status">
...
<script type="">
    ...
    var requestUrl = "http://e.losmetas.com/click.php?cnv_id=" + cnv_id + "&cnv_status=" + cnv_status;
